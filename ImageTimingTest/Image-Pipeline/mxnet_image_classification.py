...
global_model = load_model.ImagenetModel(model_path + 'synset.txt', model_path + 'vgg16')
...
def mxnet_image_classification(client=None, outputQueueName='greengrass/image_pipeline', N = 5, reshape=(224, 224) ):
    ...
    if global_model is not None:
        try:
            ...
            for filename in os.listdir(image_folderPath):
                ...
                prediction = global_model.predict_from_image(im, filepath, reshape, N)
            ...
            write_local_stats("AWS_image_local_stats_{}_vgg16.csv".format(str(datetime.datetime.now().date())), local_stats)
