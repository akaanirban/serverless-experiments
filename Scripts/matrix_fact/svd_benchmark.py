# -*- coding: utf-8 -*-
"""
Created on Tue Oct  2 15:57:28 2018
...
def time_svd(svdfunc, N1, N2, f, rseed=0, bestof=1, args=None, matfunc=np.asarray, **kwargs):
    if args is None:
        args = ()
...
def plot_numpy_svd(ax, N1, N2, f, k):
    from numpy.linalg import svd
    print("computing execution times for numpy svd...")
    t = time_svd(svd, N1, N2, f, full_matrices=False)
    ax.plot(N1, t, label='numpy (full)')
